<?php
/**
 * This endpoint is used to refresh the access token for an admin
 * 
 * @url POST /collections/admins/auth-refresh
 * @param {string} accessToken - The current access token for the admin
...
try {
    ...
    $userQuery = "SELECT * FROM admins WHERE id = ?";
