...
/**
 * This endpoint is used to authenticate users with their email and password
 *
 * @url POST /collections/users/auth-with-password
 * @param {string} identity - The user's email address
 * @param {string} password - The user's password
 * @return {object} - The user's data with an accessToken on success
